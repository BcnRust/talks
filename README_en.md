...
Repository used to propose and request talks or other activities for [BcnRust](https://www.meetup.com/bcnrust/).

## Proposing a talk

Got an idea for a talk? Raise an [issue](https://github.com/bcnrust/talks/issues) with the details and label it with `proposal`, and we'll work with you from there.
...
* What's new or coming up in the latest version of Rust (similar to [This week in Rust](http://this-week-in-rust.org/)).
...
This repository is mainly based on the Madrid user group's repo ([MadRust](https://github.com/MadRust/talks/)).